...
@pytest.mark.parametrize(
    ...
    [
        ...
        (MultiGrid(width=2, height=2, torus=False, random=random.Random(42)), OrthogonalSpaceDrawer),
        ...
        (HexMultiGrid(width=2, height=2, torus=False, random=random.Random(42)), HexSpaceDrawer),
